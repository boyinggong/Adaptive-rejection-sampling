...
sv <- ars(dnorm, c(-Inf,Inf), n = 100000, MAX_HOLDING = 100)
...
legend("topright", c("Sample Values", "Analytical Form"), col=c("blue", "red"), lwd=2, cex = .75)
...
legend("bottomright", c("Sample Values", "Analytical Form"), col=c("blue", "red"), lwd=2, cex = 1.1)


sv <- ars(dexp, c(0,Inf), n = 100000, rate=1)
...
legend("topright", c("Sample Values", "Analytical Form"), col=c("blue", "red"), lwd=2, cex = 1.25)
...
x <- seq(0,12,.01)
lines(x, dchisq(x,3), lty=5,lwd=2,col="red")
legend("topright", c("Sample Values", "Analytical Form"), col=c("blue", "red"), lwd=2, cex = 1.3)
