...
# This simulates the values for a function g defined on my_total_range
# c(xinitial, xfinal) and n is the number of samples to draw
...
system.time(sv <- simulate_things(dnorm, c(-Inf,Inf), n = 10000))
print(length(sv))
# print(sv)
